      ...
      <div className="relative rounded-3xl overflow-hidden border border-sky-200/90 shadow-[0_10px_35px_rgba(0,100,220,0.08)] bg-gradient-to-r from-[#0050A0] via-[#0066CC] to-[#0284C7] p-6 sm:p-8 text-white flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="relative z-10 bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-4 sm:p-5 w-full md:w-80 shadow-xl text-center">
          ...
          <div className="mt-2 p-3 bg-amber-400/20 border border-amber-300/40 rounded-2xl">
            ...
            <p className="text-2xl font-mono font-black text-white mt-0.5">02 : 45 : 18</p>
          </div>
        </div>
      </div>

      {/* 2. TABS */}
      <div className="bg-white rounded-3xl p-4 border border-sky-100 shadow-[0_2px_10px_rgba(0,100,220,0.04)] flex items-center justify-between">
        ...
        {filteredContests.map((c) => (
          ...
          >
            <div>
              ...
              <div className="p-5">
                <h3 className="text-sm sm:text-base font-extrabold text-[#0B3C78] leading-snug line-clamp-2 mb-2.5 group-hover:text-blue-600 transition-colors">
                  {c.title}
                </h3>

                <div className="space-y-1.5 text-xs text-slate-600 mb-3 bg-[#F8FBFE] p-3 rounded-2xl border border-sky-100">
                ...
                <div className="flex items-center gap-1.5 text-xs font-bold text-amber-700 bg-amber-50 p-2 rounded-xl border border-amber-200">
            ...
            <div className="p-5 pt-0">
              <div className="pt-3 border-t border-sky-100 flex items-center justify-between">
                <button onClick={() => setSelectedContest(c)} className="text-xs font-bold text-blue-600 hover:underline cursor-pointer">Thể lệ & Bảng điểm →</button>
                <button
                  onClick={() => {
                  ...
                  className={`px-4 py-2 rounded-2xl text-xs font-bold shadow-md flex items-center gap-1.5 cursor-pointer transition-all active:scale-98 ${
                    c.status === "ongoing"
