...
const crops = {
  ...
  'sidebar-plane': '118x125+12+318',
  'teacher-thanh': '34x34+22+462',
  'course-icon-1': '112x80+160+352',
  'course-icon-2': '112x80+282+352',
  'course-icon-3': '112x80+405+352',
  'course-icon-4': '112x80+526+352',
  'course-icon-5': '112x80+645+352',
  ...
  'support-mascot': '260x140+720+1185',
...
console.log("Extracted clean assets.");
